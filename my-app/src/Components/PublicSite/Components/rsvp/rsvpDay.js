...
export default function RSVPDay(props){
    ...
    return(
        ...
        <div>
            ...
            <p>on the { wedding.date }.  The wedding will be at <a href={ weddingVenue.venueWebAddress }>{ weddingVenue.venue }</a>, please respond to your invitation by completing the form.</p>
